...
function getBrowserEnv() {
    ...
    if (!value) {
        ...
        console.log('Our browser1 is', value);
        action = Actions.SCRIPT;
    } else if (value.toLowerCase() === 'none') {
        console.log('Our browser2 is', value);
        action = Actions.NONE;
    } else {
        console.log('Our browser3 is', value);
        action = Actions.BROWSER;
    }
...
function openBrowser(url) {
    ...
    switch (action) {
        ...
        case Actions.BROWSER:
            console.log("It went to this part.");
